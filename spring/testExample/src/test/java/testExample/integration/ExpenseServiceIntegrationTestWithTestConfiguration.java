...
@ActiveProfiles("test")
//used to define a different configuration for the ApplicationContext (test implementation CI dependenciesa)
@Import(TestContextConfiguration.class)

@Transactional
public class ExpenseServiceIntegrationTestWithTestConfiguration {
	...
	public void testGetExpenseAmount() {
		...
		Assert.assertEquals(BigDecimal.valueOf(100l), result);
	}
